The Chat Application is designed using AngularJS 1.6.4. It has following components:
...
3) service.js- it used http get command to get JSON data from JSON file hosted on server. It uses 'promise' to get data which returns the data or error depending on the response of request.
